...
public class eth : MonoBehaviour
{
    ...
    private int stopFrameCount = 3;   // 停止运动的时间，超过该值则删除对应人物
    ...
    CreatePerson[] NewPerson = new CreatePerson[367]; // 画面中累计出现367个人

    // Start is called before the first frame update
    void Start()
    {
        // 1.获取数据集
        dt = FilePath.OpenCSV("F:/大四/华科-轨迹预测/data/eth/univ/pixel_pos.csv");
        // 2. 筛选：取出第0帧数据
