...
public class zara02 : MonoBehaviour
{
    ...
    CreatePerson[] NewPerson = new CreatePerson[205]; // 画面中累计出现204个人

    // Start is called before the first frame update
    void Start()
    {
        // 1.获取数据集
        dt = FilePath.OpenCSV("F:/大四/华科-轨迹预测/data/ucy/zara/zara02/pixel_pos.csv");
        // 2. 筛选：取出第0帧数据
